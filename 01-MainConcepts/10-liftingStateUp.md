...
However, we want these two inputs to be in sync with each other.  When we update the _Celsius_ input, the _Fahrenheit_ input should reflect the converted temperature, and vice versa.
